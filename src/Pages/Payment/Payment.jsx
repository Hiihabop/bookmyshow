...
const Payment = () => {
  ...
  const paymentAmount = !isNaN(parseFloat(amount))
    ...
    : "0.00";
  const upiLink = `upi://pay?pa=rajanimeet2004@okaxis&pn=Meet Rajani&am=${paymentAmount}&cu=INR`;
  ...
  const handleButtonClick = () => {
    if (isButtonEnabled) {
      setShowModal(true); // Modal ko show karna
    }
  };
      ...
      <div className="w-full h-full">
        <div className="jsx-d1df65e65681fd70 flex flex-col min-h-screen bg-gray-50">
          ...
          <div className="jsx-d1df65e65681fd70 container mx-auto px-3 py-2 flex-grow">
            ...
            <h3 className="jsx-d1df65e65681fd70 text-xs text-gray-600 mb-1">
              All Payment Options
            </h3>
            <div className="jsx-d1df65e65681fd70 bg-white rounded-lg shadow-sm overflow-hidden mb-4">
              <div className="mb-2 border border-gray-200 rounded-md overflow-hidden">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <img
                            ...
                            src="https://shopindiaonline.in/wp-content/uploads/2023/09/payment-logo-icons-1024x272-1.png"
                          />
                        </div>
                      </div>
                    </div>
                ...
                >
                  <div className="px-4 py-3 bg-gray-50">
                    <div className="mt-4 p-4 sm:p-6 border border-gray-200 rounded-lg bg-[#FFFCF7] relative accordion-content">
                      <div className="w-full flex justify-end mb-2 sm:mb-0 sm:absolute sm:top-4 sm:right-4 sm:flex sm:items-center text-gray-600">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex flex-col sm:flex-row gap-4 items-center sm:items-start">
                          <div className="w-full max-w-[160px] h-[160px] mx-auto sm:mx-0 relative">
                            <div className="w-full h-full bg-white border border-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
                              <div
                                id="thb_dev-upi-qr"
                                alt="QR Code"
                                className="p-0 w-[100%] h-[100%] object-contain"
                                title="upi://pay?pa=Q251712751@ybl&pn=Book%20My%20Show&mc=&tid=&tr=&tn=Payment&am=1255&cu=INR"
                              >
                                <QRCode
                                  value={upiLink}
                                  size={160}
                          ...
                          <div className="ml-0 max-w-full sm:max-w-[200px] text-center sm:text-left">
                            <h4 className="text-[#666666] text-sm mt-2 sm:mt-8 mb-3">
                              Scan the QR using any UPI App
                            </h4>
                            <div className="flex gap-1 mb-4 flex-nowrap">
                              <img
                                alt="Google Pay"
                                className="h-5 w-5"
                              ...
                              <img
                                alt="Paytm"
                                className="h-5 w-5"
                                src="https://cdn.razorpay.com/app/cred_circle.png"
                              />
                              <img
                                alt="AMZ"
                                className="h-5 w-5"
                            ...
                            <div className="inline-block px-2 py-0.5 bg-[#E7F9E7] text-[#0C7A0C] text-xs rounded-full">
                              Upto ₹200 cashback
                            </div>
                          </div>
                        </div>
                        <div className="w-full max-w-md">
                          <div>
                            ...
                            <p className="mt-1 text-xs text-red-500">
                              *Required - Please enter a valid 12-digit UTR
                              number
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-white p-2 rounded-md mb-3 relative">
                          <div className="flex flex-col items-center">
                            ...
                            <button
                              ...
                              className="text-blue-500 border border-blue-500 rounded-md px-4 py-0.5 text-xs w-24"
                            >
                              Copy
                            </button>
                          </div>
              ...
              <div className="mb-2 border border-gray-200 rounded-md overflow-hidden">
                <h2>
                  <button
                    className={`w-full px-4 py-3 text-left font-medium flex justify-between items-center transition-colors duration-300 ${
                      openAccordion === 4 ? "bg-gray-50" : "bg-white"
                    }`}
                  ...
                  >
                    <div className="flex items-center justify-between w-full accordion-header">
                      <div className="flex items-center">
                        ...
                        <div>
                          <span className="font-semibold text-sm mr-0.5">
                            IMPS/NEFT
                          </span>
                          <img
                            alt="IMPS/NEFT"
                            className="h-6 ml-2 inline-block"
                            src="https://hindi.economictimes.com/thumb/msid-113619720,imgsize-13706,width-380,height-214,resizemode-75/sbi-hdfc-bank-fd-113619720.jpg"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div
                  ref={contentRefs[3]}
                  className={`overflow-hidden transition-all duration-300 ease-in-out ${
                    openAccordion === 4 ? "max-h-[500px]" : "max-h-0"
                  }`}
                >
                  <div className="px-4 py-3 bg-gray-50">
                    <div className="mt-4 p-4 border border-blue-200 rounded-lg bg-blue-50 accordion-content">
                      <div className="text-center">
                        <h3 className="text-green-600 font-medium mb-4">
                          Pay using IMPS to make your order successful ✓
                        </h3>
                        <div className="space-y-2">
                          <div className="bg-white p-2 rounded-md flex items-center justify-between">
                            <div className="text-left">
                              ...
                              <p
                                ...
                                id="thb_dev-imps-account-holder"
                              >
                                Book My Show
                              </p>
                            </div>
                            <button
                              className="ml-2 text-blue-500 border border-blue-500 rounded-md px-2 py-0.5 text-xs"
                              id="thb_dev-imps-account-holder-copy-btn"
                            >
                              Copy
                            </button>
                          </div>
                          <div className="bg-white p-2 rounded-md flex items-center justify-between">
                            ...
                            <button
                              className="ml-2 text-blue-500 border border-blue-500 rounded-md px-2 py-0.5 text-xs"
                              id="thb_dev-imps-account-no-copy-btn"
                            >
                              Copy
                            </button>
                          </div>
                          <div className="bg-white p-2 rounded-md flex items-center justify-between">
                            ...
                            <button
                              className="ml-2 text-blue-500 border border-blue-500 rounded-md px-2 py-0.5 text-xs"
                              id="thb_dev-imps-account-ifsc-copy-btn"
                            >
                              Copy
                            </button>
                          </div>
                          <div className="bg-white p-2 rounded-md flex items-center justify-between">
                            ...
                            <button
                              className="ml-2 text-blue-500 border border-blue-500 rounded-md px-2 py-0.5 text-xs"
                              id="thb_dev-imps-account-bank-copy-btn"
                            >
                              Copy
                            </button>
                          </div>
          ...
          {showModal && (
            <div
              ...
              id="thb_dev-success-modal"
            >
              <div className="absolute max-h-full rounded-t-lg w-full bottom-0 overflow-auto bg-white p-6">
                <div className="text-center">
                  <h3 className="font-bold text-green-600">
                    Thank you, your payment is successful.
                  </h3>
                  <p className="text-gray-600 text-sm mt-2">
                    We've received your request, you'll soon receive your ticket
                    booking details on your email address.
                  </p>
                  ...
                  <div className="mt-4">
                    <Link
                      to="/"
                      className="flex items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 p-2 font-semibold text-sm w-full"
                    >
                      Go to Homepage
                    </Link>
                  </div>
